...
try:
    ...
    hardware_capabilities = metal_hardware_optimizer.hardware_capabilities
    AppleSiliconGeneration = metal_hardware_optimizer.AppleSiliconGeneration
...
if has_instrumentation:
    _instrumentation = metal_instrumentation.get_metal_instrumentation()
    _error_diagnostics = metal_instrumentation.get_error_diagnostics()
else:
